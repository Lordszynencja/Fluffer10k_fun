...
public class FightSpecialAttackGouge implements FightActionHandler {
	...
	public FightSpecialAttackGouge(final Fluffer10kFun fluffer10kFun, final FightAttack fightAttack) {
	...
	public void handle(final FightTempData data, final RPGFightAction action) {
		...
		final boolean spellCast = fluffer10kFun.fightActionUtils.castSpell(data, ActiveSkill.GOUGE, 2);
		if (!spellCast) {
			return;
		}
