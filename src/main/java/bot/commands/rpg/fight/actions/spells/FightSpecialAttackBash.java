...
public class FightSpecialAttackBash implements FightActionHandler {
	...
	public FightSpecialAttackBash(final Fluffer10kFun fluffer10kFun, final FightAttack fightAttack) {
	...
	public void handle(final FightTempData data, final RPGFightAction action) {
		...
		final boolean spellCast = fluffer10kFun.fightActionUtils.castSpell(data, ActiveSkill.BASH, 3);
		if (!spellCast) {
			return;
		}
