...
public class QueenSlime extends EnemiesOfRace {
	...
	protected void addEnemies(final Fluffer10kFun fluffer10kFun, final RPGEnemies rpgEnemies) {
		makeBuilder(QUEEN_SLIME_1)//
				.strength(4).agility(2).intelligence(3)//
				.baseHp(10)//
				.diff(2)//
				.classes(FighterClass.WEAK_TO_FIRE, FighterClass.WET)//
				.actionSelector(fluffer10kFun.rpgEnemyActionSelectorUtils.actionsFrom(//
						pair(1, RPGFightAction.ATTACK_S_3), //
						pair(1, RPGFightAction.GRAB_SLIME)))//
				.build(rpgEnemies);
		makeBuilder(QUEEN_SLIME_2)//
				.strength(7).agility(3).intelligence(6)//
				.baseHp(20)//
				.diff(4)//
				.classes(FighterClass.DOUBLE_ATTACK, FighterClass.WEAK_TO_FIRE, FighterClass.WET)//
				.actionSelector(fluffer10kFun.rpgEnemyActionSelectorUtils.actionsFrom(//
						pair(1, RPGFightAction.ATTACK_S_3), //
						pair(1, RPGFightAction.GRAB_SLIME)))//
				.build(rpgEnemies);
		makeBuilder(QUEEN_SLIME_3)//
				.strength(11).agility(5).intelligence(17)//
				.baseHp(40)//
				.diff(10)//
				.classes(FighterClass.TRIPLE_ATTACK, FighterClass.WEAK_TO_FIRE, FighterClass.WET)//
				.actionSelector(fluffer10kFun.rpgEnemyActionSelectorUtils.actionsFrom(//
						pair(1, RPGFightAction.ATTACK_S_3), //
