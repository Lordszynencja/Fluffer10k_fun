...
public abstract class EnemiesOfRace {
	...
	protected final RPGEnemyMonsterGirlDataBuilder makeBuilder2(final int id) {
		return makeBuilder2(Integer.toString(id));
	}

	protected final RPGEnemyMonsterGirlDataBuilder makeBuilder2(final String id) {
		return new RPGEnemyMonsterGirlDataBuilder(race.name() + "_" + id, race);
	}
}
